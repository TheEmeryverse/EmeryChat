...
_ALIASES = {
    ...
    "generate_image": ("image", "draw", "illustrate"),
    ...
    "run_command": ("terminal", "shell", "command", "execute command", "system command"),
    ...
    "terminal_exec": ("terminal", "shell", "run command", "one-shot command"),
    "terminal_session_start": ("terminal", "interactive shell", "persistent session", "shell state"),
...
_EAGER_DEFAULTS = {
    ...
    "fetch_web_content", "use_research_image", "get_youtube_transcript", "get_system_stats",
