...
def _to_csv_tuple(value, default=()):
    if value is None:
...
ENABLE_LIVE_STEERING = _to_bool(os.getenv("ENABLE_LIVE_STEERING"), True)
LIVE_STEERING_MAX_PENDING = _to_int(os.getenv("LIVE_STEERING_MAX_PENDING"), 4)
LIVE_PROGRESS_MIN_DELAY_SECONDS = _to_float(os.getenv("LIVE_PROGRESS_MIN_DELAY_SECONDS"), 1.2)
LIVE_PROGRESS_EDIT_INTERVAL_SECONDS = _to_float(os.getenv("LIVE_PROGRESS_EDIT_INTERVAL_SECONDS"), 1.5)
LIVE_PROGRESS_HEARTBEAT_INTERVAL_SECONDS = _to_float(os.getenv("LIVE_PROGRESS_HEARTBEAT_INTERVAL_SECONDS"), 15.0)
LIVE_PROGRESS_MAX_CHARS = _to_int(os.getenv("LIVE_PROGRESS_MAX_CHARS"), 240)
...
MAIN_MODEL_VISION = _to_bool(os.getenv("MAIN_MODEL_VISION"), False)
MAIN_MODEL_IMAGE_FORMAT = os.getenv("MAIN_MODEL_IMAGE_FORMAT", "openai").strip().lower()
...
FAST_MODEL_ENABLE_THINKING = _to_bool(os.getenv("FAST_MODEL_ENABLE_THINKING"), False)
FAST_MODEL_DOMINANT = _to_bool(os.getenv("FAST_MODEL_DOMINANT"), False)
...
RESEARCH_IMAGE_MAX_DIMENSION = max(256, _to_int(os.getenv("RESEARCH_IMAGE_MAX_DIMENSION"), 1600))
...
EXPERT_FAST_TOP_P = _to_float(os.getenv("EXPERT_FAST_TOP_P"), 0.95)
EXPERT_FAST_TOP_K = _to_int(os.getenv("EXPERT_FAST_TOP_K"), 80)
EXPERT_FAST_MIN_P = _to_float(os.getenv("EXPERT_FAST_MIN_P"), 0.05)
EXPERT_FAST_PRESENCE_PENALTY = _to_float(os.getenv("EXPERT_FAST_PRESENCE_PENALTY"), 0.0)
EXPERT_FAST_REPETITION_PENALTY = _to_float(os.getenv("EXPERT_FAST_REPETITION_PENALTY"), 1.05)
DEBATE_INITIAL_POSITION_SOURCE_LIMIT = max(1, _to_int(os.getenv("DEBATE_INITIAL_POSITION_SOURCE_LIMIT"), 2))
DEBATE_SIDE_LIGHT_SOURCE_LIMIT = max(1, _to_int(os.getenv("DEBATE_SIDE_LIGHT_SOURCE_LIMIT"), 2))
DEBATE_SIDE_DEEP_SOURCE_LIMIT = max(1, _to_int(os.getenv("DEBATE_SIDE_DEEP_SOURCE_LIMIT"), 5))
DEBATE_ROUND_SOURCE_LIMIT = max(0, _to_int(os.getenv("DEBATE_ROUND_SOURCE_LIMIT"), 1))
DEBATE_MIN_ROUNDS = max(1, _to_int(os.getenv("DEBATE_MIN_ROUNDS"), 3))
DEBATE_MAX_ROUNDS = max(DEBATE_MIN_ROUNDS, _to_int(os.getenv("DEBATE_MAX_ROUNDS"), 3))
...
SKILLS_STORE_PATH = os.getenv("SKILLS_STORE_PATH", "data/skills/skills_store.json")
SKILL_WRITE_APPROVAL = _to_bool(os.getenv("SKILL_WRITE_APPROVAL"), False)
SKILL_AUTO_APPROVE = _to_bool(os.getenv("SKILL_AUTO_APPROVE"), False)
SKILL_MAX_CHARS = max(1000, _to_int(os.getenv("SKILL_MAX_CHARS"), 12000))
SKILL_MAX_RETRIEVAL_CHARS = max(1000, _to_int(os.getenv("SKILL_MAX_RETRIEVAL_CHARS"), 8000))
...
IMAGE_GENERATION_BACKEND = os.getenv("IMAGE_GENERATION_BACKEND", "gemini").strip().lower()
IMAGE_MAX_BATCH_SIZE = max(1, _to_int(os.getenv("IMAGE_MAX_BATCH_SIZE"), 10))
COMFYUI_URL = os.getenv("COMFYUI_URL", "http://127.0.0.1:8188").rstrip("/")
COMFYUI_WORKFLOW_PATH = os.getenv("COMFYUI_WORKFLOW_PATH", "").strip()
COMFYUI_AUTH_TOKEN = os.getenv("COMFYUI_AUTH_TOKEN", "").strip()
COMFYUI_TIMEOUT_SECONDS = max(60, _to_int(os.getenv("COMFYUI_TIMEOUT_SECONDS"), 900))
COMFYUI_POLL_INTERVAL_SECONDS = max(0.2, _to_float(os.getenv("COMFYUI_POLL_INTERVAL_SECONDS"), 1.0))
QWEN_ENCODER_URL = os.getenv("QWEN_ENCODER_URL", "http://192.168.1.121:8086").rstrip("/")
...
DOCLING_BEARER_TOKEN = os.getenv("DOCLING_BEARER_TOKEN", "").strip()
...
ENABLE_DOCLING = _to_bool(os.getenv("ENABLE_DOCLING"), True)
ENABLE_YOUTUBE_TRANSCRIPT = _to_bool(os.getenv("ENABLE_YOUTUBE_TRANSCRIPT"))
...
ENABLE_HEARTBEAT = _to_bool(os.getenv("ENABLE_HEARTBEAT"), False)
...
MEALIE_MAX_URLS_PER_MESSAGE = _to_int(os.getenv("MEALIE_MAX_URLS_PER_MESSAGE"), 5)
